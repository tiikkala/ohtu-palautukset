...
public class KauppaTest {
    ...
    public void ostoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaanOikeallaAsiakkaallaTilinumerollaJaSummalla() {
        ...
        // sitten suoritetaan varmistus, että pankin metodia tilisiirto on kutsuttu oikealla asiakkaalla, tilinumerolla ja summalla
    ...
    public void kahdenTuotteenOstoksenPaaytyttyaPankinMetodiaTilisiirtoKutsutaan() {
        ...
        // määritellään että tuoete numero 2 on makkara jonka hinta on 7 ja saldo 5
    ...
    public void aloitaAsiointiNollaaEdellisenOstoksenTiedot() {
        ...
        k.lisaaKoriin(1);     // ostetaan tuotetta numero 1 eli maitoa
        k.tilimaksu("pekka", "12345");
        k.aloitaAsiointi();   // uusi ostotapahtuma
        k.lisaaKoriin(1);     // ostetaan tuotetta numero 1 eli maitoa
        k.tilimaksu("pekka", "12345");
        // sitten suoritetaan varmistus, että pankin metodia tilisiirto on kutsuttu oikealla asiakkaalla, tilinumerolla ja summalla kaksi kertaa
        verify(pankki, times(2)).tilisiirto(eq("pekka"), eq(42), eq("12345"), anyString(), eq(5));
    }

    @Test
    public void eriOstoksilleGeneroituuEriViitteet() {
        ...
        k.lisaaKoriin(1);     // ostetaan tuotetta numero 1 eli maitoa
        k.tilimaksu("pekka", "12345");
        // sitten suoritetaan varmistus, että viite on generoitu kaksi kertaa
    ...
    public void poistaKoristaPalauttaaTuotteenVarastoon() {
        ...
        // määritellään tuotteen ID:ksi 1
        when(tuote.getId()).thenReturn(1);
        
        Varasto varasto = mock(Varasto.class);
        // määritellään että tuotteen 1 saldo on 10
        ...
        k.aloitaAsiointi();
        k.lisaaKoriin(1);     // ostetaan tuotetta numero 1 eli maitoa
        k.poistaKorista(1); // poistetaan tuote numero 1
